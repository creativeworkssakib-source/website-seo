...
async function handleAnalyze() {
    ...
    try {
        ...
        if (response && response.success && response.message) {
            // Add the actual AI analysis
            addBotMessage(response.message);
        } else {
            // Fallback if no proper response
            addBotMessage(`"${url}" এর বিশ্লেষণ সম্পন্ন হয়েছে। আপনার কোনো প্রশ্ন থাকলে জিজ্ঞাসা করুন। 📊`);
        }
...
async function handleSendMessage() {
    ...
    try {
        ...
        if (response && response.success && response.message) {
            ...
            // If no proper response, show error
            addBotMessage('দুঃখিত, উত্তর পেতে সমস্যা হয়েছে। আবার চেষ্টা করুন।');
        }
...
async function sendToWebhook(data) {
    try {
        console.log('Sending to webhook:', data); // Debug log
        ...
        console.log('Webhook response data:', result); // Debug log
